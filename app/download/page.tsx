    ...
    <div className='flex flex-col gap-4 h-screen w-full'>
      <div className='flex flex-col'>
        <div className='flex items-start gap-4 max-w-full overflow-auto overflow-x-hidden md:max-h-[69vh] max-h-[80vh] flex-wrap scrollbarStyle justify-center'>
          ...
          <DownloadCard title='Vencord' description='Vencord is a desktop client mod with ReviewDB and many other plugins' downloadLink='https://github.com/Vencord/Installer/releases/latest' icon_url='/platforms/vencord.png' />
