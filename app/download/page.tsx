    ...
    <div className='flex flex-col gap-4 h-screen w-full'>
      <div className='flex flex-col'>
        <div className='flex items-start gap-4 max-w-full overflow-auto overflow-x-hidden md:max-h-[69vh] max-h-[80vh] flex-wrap scrollbarStyle justify-center'>
          ...
          <DownloadCard title='Vencord' description='Vencord is a desktop client mod with ReviewDB and many other plugins' downloadLink='https://vencord.dev/download/' icon_url='/platforms/vencord.png' />
          ...
          <DownloadCard title='Vendetta' description='Vendetta is a Discord client mod which supports both Android and iOS, and is based on the new app versions' websiteLink='https://github.com/vendetta-mod/Vendetta' downloadLink='https://janisslsm.github.io/vdplugins/ReviewDB/' icon_url='/platforms/vendetta.png' />
