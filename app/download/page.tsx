    ...
    <div className='flex flex-col gap-4 h-screen w-full'>
      <div className='flex flex-col'>
        <div className='flex items-start gap-4 max-w-full overflow-auto overflow-x-hidden md:max-h-[69vh] max-h-[80vh] flex-wrap scrollbarStyle justify-center'>
          <DownloadCard title='Twitter' description='ReviewDB for Social Media platform Twitter' downloadLink='https://chrome.google.com/webstore/detail/reviewdb-twitter/kmgbgncbggoffjbefmnknffpofcajohj' icon_url='/logo.png' />
          <DownloadCard title='Vencord+' description='Vencord+ is fork of desktop client mod called Vencord with mod with ReviewDB integrated' downloadLink='https://github.com/StupidityDB/VencordPlusInstaller/releases/latest' icon_url='/platforms/vencord.png' />
